  ...
  return (
    ...
    >
      <div className=" flex flex-col justify-center pl-20 max-sm:px-2">
        ...
        <div className="border-[1px] border-b-secondaryGreen w-[120px] max-sm:w-[150px]"></div>
        ...
        This charming colonial-style bungalow, nestled amidst a serene tea plantation, offers a tranquil retreat surrounded by breathtaking mountain views and lush greenery. With its quiet ambiance and meticulously designed garden adorned with vibrant exotic flowers, the bungalow creates a perfect setting for a rejuvenating holiday.
        </p>
        <p className="max-w-[40rem] mt-3 font-quicksand max-sm:text-sm">The property features four spacious and tastefully furnished bedrooms, each with its own en-suite bathroom for your comfort and convenience.</p>
        <div>

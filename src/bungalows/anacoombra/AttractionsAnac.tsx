...
import { placesVidListAnac } from "../../utils/constants";

gsap.registerPlugin(ScrollTrigger);

const AttractionsAnac = () => {
  ...
  return (
    <div
      className=" lg:px-[100px] px-[20px] bg-primaryGreen py-[100px] max-sm:pt-[40px] max-sm:pb-[50px] text-white"
      id="attractions"
    >
      <div className="flex flex-col items-center">
        ...
        <div className="border-b-[1px] border-secondaryGreen w-[100px] att-AnimTxt"></div>
      </div>
        ...
        {placesVidListAnac.map((item, i) => (
          ...
          >
            ...
            >
              ...
              <a
                href="/"
                className="bg-secondaryGreen flex justify-center items-center w-[80px] mt-2 h-[30px] rounded-lg"
              >
...
export default AttractionsAnac;

...
const ContactWorld = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-secondaryBlue flex flex-col border-primaryBlue border-[2px] rounded-3xl shadow-2xl px-10 max-sm:px-2 book-container">
        <h2 className="text-center pt-5 pb-4 border-b-[1px] border-primaryBlue text-xl">
          Book your Stay at <span>Mini World's End</span>
        </h2>
        <div className="flex border-b-[1px] border-primaryBlue py-8 gap-5">
          <input
            placeholder="Full Name"
            type="text"
            name=""
            id=""
            className="focus:outline-none placeholder:text-primaryBlue/40 bg-transparent border-b-[1px] border-primaryBlue w-[50%]"
          />
          <input
            type="text"
            placeholder="Email"
        ...
        <div className="flex items-center justify-between text-center border-b-[1px] border-primaryBlue py-8 gap-5 w-full">
          <div className="border-opacity-60 flex flex-col items-center justify-center">
            ...
            <div className="mt-2 flex items-center gap-2 font-extralight opacity-80">
              ...
              >
                <FaCircleMinus
                  className={`text-xl ${
                    adultCount == 1 ? "text-white" : "text-primaryBlue"
                  }`}
                />
              </button>
              <p className="border-[1px] border-primaryBlue rounded-sm pt-1 px-1 w-8 text-center">
                {adultCount}
              </p>
              <button onClick={() => setAdultCount((count) => count + 1)}>
                <FaCirclePlus className="text-xl text-primaryBlue" />
              </button>
            </div>
          </div>
          <div className="flex flex-col gap-4">
            <div className=" border-opacity-60 w-full">
              ...
              <DatePicker
                ...
                className="border-b-[1px] border-primaryBlue mt-2 font-quicksand max-sm:text-center font-thin focus:outline-none pl-1 text-xl max-sm:text-sm bg-transparent w-[120px] max-sm:w-full"
            ...
            <div className="border-opacity-60 w-full">
              ...
              <DatePicker
                ...
                className="border-b-[1px] mt-2 border-primaryBlue font-quicksand font-thin max-sm:text-center focus:outline-none pl-1 text-xl max-sm:text-sm bg-transparent w-[120px] max-sm:w-full"
                dateFormat={"dd MMM, yyyy"}
              />
            </div>
          </div>
          <div className="border-opacity-60 flex flex-col items-center justify-center">
            ...
            <div className="mt-2 flex items-center gap-2 font-extralight opacity-80">
              ...
              >
                <FaCircleMinus
                  className={`text-xl ${
                    childrenCount == 0 ? "text-white" : "text-primaryBlue"
                  }`}
                />
              </button>
              <p className="border-[1px] border-primaryBlue rounded-sm pt-1 px-1 w-8 text-center">
        ...
        <div className=" flex py-8 max-sm:py-4 items-center justify-center ">
          <button className="bg-primaryBlue hover:bg-primaryBlue/50 transition-all active:scale-90 text-white font-thin rounded-md border-[1px] pb-[2px] px-3 pt-[5px]">
            Send Inquiry
          </button>
        </div>
      </div>

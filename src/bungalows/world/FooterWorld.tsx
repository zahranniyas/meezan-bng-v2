...
const FooterWorld = () => {
  return (
    <div className=" bg-primaryBlue flex max-sm:flex-col max-sm:items-center max-sm:gap-5 justify-between text-white font-quicksand font-thin px-[20px] lg:px-[200px] py-10">

...
import { placesVidListWorld } from "../../utils/constants";

gsap.registerPlugin(ScrollTrigger);

const AttractionsWorld = () => {
  ...
  return (
    <div
      className=" lg:px-[100px] px-[20px] bg-primaryBlue py-[100px] max-sm:pt-[40px] max-sm:pb-[50px] text-white"
      id="attractions"
    >
      <div className="flex flex-col items-center">
        ...
        <div className="border-b-[1px] border-secondaryBlue w-[100px] att-AnimTxt"></div>
      </div>
        ...
        {placesVidListWorld.map((item, i) => (
          ...
          >
            ...
            >
              ...
              <a
                href="/"
                className="bg-secondaryBlue flex justify-center items-center w-[80px] mt-2 h-[30px] rounded-lg"
              >
...
export default AttractionsWorld;

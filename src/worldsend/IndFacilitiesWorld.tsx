...
import { indoorListWorld } from "../utils/constants";

gsap.registerPlugin(ScrollTrigger);

const IndFacilitiesWorld = () => {
  // Loading
  useGSAP(() => {
  ...
  return (
    ...
    >
      ...
      <div className="border-b-[1px] border-secondaryBlue w-[100px] facInd-text"></div>
...
export default IndFacilitiesWorld;
